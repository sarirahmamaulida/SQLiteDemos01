package id.ac.poliban.sari.sqlitedemos01;
...
import id.ac.poliban.sari.sqlitedemos01.adapter.FriendAdapter;
import id.ac.poliban.sari.sqlitedemos01.dao.impl.FriendDaoImplSQLite;
import id.ac.poliban.sari.sqlitedemos01.domain.Friend;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setSubtitle("Sari Studios");
        }
